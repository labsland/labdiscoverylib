...
from labdiscoverylib.utils import create_token, _current_session_id, _current_weblab

from labdiscoverylib.exc import AlreadyRunningError, TimeoutError
...
#         return WebLabTask(self._weblab, task_id)
    ...
    def run_sync(self, *args, **kwargs):
        ...
        process, and configure labdiscoverylib so all the tasks are run there (by setting
